...
const fieldProps = ({ componentMapper }: PropertiesFieldsInput) => [
  ...
  },
  {
    ...
    label: "Name",
    description:
      "Name of the field. You can use dot notation to nest variables.",
    isRequired: true,
    validate: [{ type: "required" }],
  },
  {
    ...
    fields: [
      {
        ...
        name: "title",
        label: "Title",
        description: "Title of the sub-form.",
      },
      {
        component: "text-field",
        name: "description",
        label: "Description",
        description: "Description of the sub-form.",
      },
    ],
  },
  {
    ...
    condition: {
      when: "component",
      is: ["select", "radio", "checkbox", "field-array", "dual-list-select"],
    },
    fields: [
      {
        ...
        defaultItem: () => ({ value: `value-${Date.now()}`, label: "label" }),
        fields: [
          {
            label: "Label",
            name: "label",
  ...
  },
  {
    ...
    content:
      "Components also accept custom props. Check documentation for you components/mapper to read more.",
    maxWidth: "320px",
    size: 300,
  },
]
...
const validatorFields = () => [
  {
    ...
    marginBottom: "4px",
    description:
      "Enable to use warnings - validators, that do not prevent to submit the form.",
  },
  {
    component: "field-array",
    name: "validate",
    label: "Validators",
    description: "Available validators.",
    defaultItem: {},
    fields: [
      {
        label: "Type",
      ...
      },
      {
        ...
        condition: {
          ...
          is: ["min-length", "max-length", "exact-length"],
        },
        validate: [{ type: "required" }],
        clearOnUnmount: true,
      },
      {
        ...
        condition: {
          ...
          is: ["min-number-value", "max-number-value"],
        },
        clearOnUnmount: true,
        validate: [{ type: "required" }],
      },
      {
        ...
        condition: {
          when: (field: Field) =>
            `${field.name.replace("includeThreshold", "type")}`,
          is: ["min-number-value", "max-number-value"],
        },
        clearOnUnmount: true,
      },
    ...
    fields: [
      {
        name: "props-tab",
        title: "Props",
        fields: fieldProps({ componentMapper }),
      },
      {
        name: "validators-tabs",
        title: "Validators",
